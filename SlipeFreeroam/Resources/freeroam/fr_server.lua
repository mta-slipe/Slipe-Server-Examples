...
-- resets timers
-- DONE
-- disables vehicle fire if configured
-- TODO
...
-- Start timer to destroy vehicle
-- DONE
-- enabled vehicle fire
-- TODO
...
-- sets vehicle to be destroyed in 5 seconds
-- DONE
-- reset ped gravity
-- TODO
...
-- destroys vehicle and accompanying data
-- DONE
...
-- Handling all events
-- Replacing by inidividual events
-- DONE
...
-- trims colorcodes
-- Already available with .StripColorCode()
